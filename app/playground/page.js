...
export default function Page() {
  return (
    <main className="space-y-8 mb-44">
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">PageHeader</h2>
        <Separator />
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">Trend</h2>
        <Separator />
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">TransactionItem</h2>
        <Separator />
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">Buttons</h2>
        <Separator />
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">Forms</h2>
        <Separator />
      ...
      <div>
        <h2 className="text-lg mb-4 font-mono">Loading Skeleton</h2>
        <Separator />
